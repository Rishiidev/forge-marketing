...
// Forge brand palette (lib/design-tokens.ts colors.paper/mark/ground),
// normalized to 0..1 — swapped in for the generator's default neon-green
// preset so the mesh reads as a soft, on-brand wash rather than a loud
// standalone gradient.
const UNIFORMS = {
  colors: [
    [0.9608, 0.9529, 0.9255], // paper.DEFAULT #F5F3EC
    [0.9294, 0.9176, 0.8784], // paper.2 #EDEAE0
    [0.8392, 0.8667, 0.6275], // mark.DEFAULT #D6DDA0
    [0.7176, 0.7529, 0.4549], // mark.2 #B7C074
    [0.2902, 0.2941, 0.1647], // ground.3 #4A4B2A
